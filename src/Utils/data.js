...
export const Data = [
  ...
  },
  {
    ...
    primaryTitle: "How to Favicon in 2022: Six files that fit most needs",
    description:
  ...
  {
    name: "Colors Box",
    secondaryTitle: "colors",
    primaryTitle: "A whistle-stop tour of 4 new CSS color features",
    description:
  ...
  {
    name: "Careers Box",
    secondaryTitle: "Careers",
    primaryTitle: "Looking for you!",
    description:
      "As part of your role, you will have the opportunity to develop from scratch, working closely with the product, design, and QA teams to deliver the best product. This is a great opportunity to join us and grow with other team members. Send CV to Jobsil@abra-it.com",
  },
];
